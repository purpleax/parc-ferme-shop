...
```
├── package.json            # root scripts (setup/seed/fetch-images/dev/test/demo)
├── scripts/
│   ├── demo.mjs            # end-to-end API demo/test script
...
Full interactive docs: **http://localhost:4000/api/docs** (spec at `/api/openapi.json`).
